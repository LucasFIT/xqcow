jQuery(document).ready(function ($) {
    ...
    $('.mdwbm_remove_file').on('click', function (event) {
    ...
    $('.wbm_shop_page_remove_single_file').on('click', function (event) {
    ...
    if ( "true" === wbmAdminVars.can_use_premium_code || true === wbmAdminVars.can_use_premium_code ) {
        ...
        $('.wbm_other_page_remove_file').on('click', function (event) {
    ...
    $('.wbm_other_page_remove_single_file').on('click', function (event) {
...
if ( "true" === wbmAdminVars.can_use_premium_code || true === wbmAdminVars.can_use_premium_code ) {
    ...
    $('.wbm_shop_page_remove_file').on('click', function (event) {
    ...
    //remove the cart single banner image script
    $('.wbm_cart_page_remove_single_file').on('click', function (event) {
...
if ( "true" === wbmAdminVars.can_use_premium_code || true === wbmAdminVars.can_use_premium_code ) {
    ...
    $('.wbm_cart_page_remove_file').on('click', function (event) {
    ...
    $('.wbm_checkout_page_remove_single_file').on('click', function (event) {
    ...
    $('.wbm_banner_detail_page_remove_single_file').on('click', function (event) {
...
if ( "true" === wbmAdminVars.can_use_premium_code || true === wbmAdminVars.can_use_premium_code ) {
    ...
    $('.wbm_checkout_page_remove_file').on('click', function (event) {
    ...
    $('.wbm_thankyou_page_remove_single_file').on('click', function (event) {
...
if ( "true" === wbmAdminVars.can_use_premium_code || true === wbmAdminVars.can_use_premium_code ) {
    ...
    function remove_slider_image_init() {
        $('.cat-single-image-delete').on('click', function (event) {
            var imageId;
    ...
    function remove_shop_page_slider_image_init() {
        $('.shop-single-image-delete').on('click', function (event) {
            var imageId;
            if (confirm(wbmAdminVars.alert)) {
                imageId = $(this).attr('id');
    ...
    function remove_other_page_slider_image_init() {
        $('.other-single-image-delete').on('click', function (event) {
            var imageId;
            if (confirm(wbmAdminVars.alert)) {
                imageId = $(this).attr('id');
    ...
    function remove_cart_page_slider_image_init() {
        $('.cart-single-image-delete').on('click', function (event) {
            var imageId;
            if (confirm(wbmAdminVars.alert)) {
                imageId = $(this).attr('id');
    ...
    function remove_checkout_page_slider_image_init() {
        $('.checkout-single-image-delete').on('click', function (event) {
            var imageId;
            if (confirm(wbmAdminVars.alert)) {
                imageId = $(this).attr('id');
    ...
    function remove_thankyou_page_slider_image_init() {
        $('.thankyou-single-image-delete').on('click', function (event) {
            var imageId;
            if (confirm(wbmAdminVars.alert)) {
                imageId = $(this).attr('id');
    ...
    function remove_banner_detail_page_slider_image_init() {
        $('.banner_detail-single-image-delete').on('click', function (event) {
            var imageId;
            if (confirm(wbmAdminVars.alert)) {
                imageId = $(this).attr('id');
    ...
    $('.wbm-shortcode-wrap .wbm-code').click(function (e) {
        e.preventDefault();
        var text = $(this).text();
        wbm_copyToClipboard($(this));
        $(this).focus().select();
    ...
    function wbm_copyToClipboard(element) {
        var $temp = $("<input>");
        $("body").append($temp);
