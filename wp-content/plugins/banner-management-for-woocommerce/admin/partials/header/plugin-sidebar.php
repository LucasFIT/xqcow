...
$tweet_url = 'https://twitter.com/share?text=' . rawurlencode( "I use Category Banner Management Plugin for #WooCommerce by @dotstore to help add the banner on checkout pages for #customerorders Enhance your customer experience of #productpages with banner images. Checkout this #plugin" ) . '&amp;hashtags=wordpress,woo &amp;url=https://wordpress.org/plugins/banner-management-for-woocommerce/';
$review_url = '';
$plugin_at = '';
$changelog_url = '';
...
esc_html_e( 'Upgrade to Banner Manageent Pro', 'woo-banner-management' );
?></span>
            </div>
            <div class="dotstore-important-link-content">
                <ul class="dotstore-pro-list">
                    <li><?php 
esc_html_e( 'Manage Category Specific Banner (e.g.shoes, Apparel)', 'woo-banner-management' );
?></li>
                    <li><?php 
esc_html_e( 'Add Single and Multiple Banner for page category', 'woo-banner-management' );
?></li>
                    <li><?php 
esc_html_e( 'Random and Multiple Banner slider for page and category', 'woo-banner-management' );
?></li>
                    <li><?php 
esc_html_e( 'Auto scheduling Banner slider for page and category', 'woo-banner-management' );
?></li>
                    <li><?php 
esc_html_e( 'Display Navigation and add custom link', 'woo-banner-management' );
?></li>
                    <li><?php 
esc_html_e( 'Preview custom banner', 'woo-banner-management' );
?></li>
                </ul>
                <div class="dotstore-pro-button">
                    <a class="button" target="_blank" href="<?php 
echo  esc_url( 'https://bit.ly/2KWQzCH' ) ;
?>"><?php 
esc_html_e( 'Get Premium Now »', 'woo-banner-management' );
?></a>
                </div>
            </div>
        </div>
...
echo  esc_url( plugins_url( '/images/popular-plugins/Advanced-Flat-Rate-Shipping-Method.png', dirname( dirname( __FILE__ ) ) ) ) ;
?>">
                    <a target="_blank" href="<?php 
echo  esc_url( 'https://www.thedotstore.com/flat-rate-shipping-plugin-for-woocommerce/' ) ;
?> "><?php 
esc_html_e( 'Flat Rate Shipping Plugin for WooCommerce', 'woo-banner-management' );
?></a>
                </li> 
                <li>
                    <img class="sidebar_plugin_icone" src="<?php 
echo  esc_url( plugins_url( '/images/popular-plugins/Conditional-Product-Fees-For-WooCommerce-Checkout.png', dirname( dirname( __FILE__ ) ) ) ) ;
?>">
                    <a  target="_blank" href="<?php 
echo  esc_url( 'https://www.thedotstore.com/product/woocommerce-extra-fees-plugin/' ) ;
?>"><?php 
esc_html_e( 'Extra Fees Plugin for WooCommerce', 'woo-banner-management' );
?></a>
                </li>
                <li>
                    <img class="sidebar_plugin_icone" src="<?php 
echo  esc_url( plugins_url( '/images/popular-plugins/Advanced-Product-Size-Charts-for-WooCommerce.png', dirname( dirname( __FILE__ ) ) ) ) ;
?>">
                    <a  target="_blank" href="<?php 
echo  esc_url( 'https://www.thedotstore.com/woocommerce-advanced-product-size-charts/' ) ;
?>"><?php 
esc_html_e( 'Product Size Charts Plugin for WooCommerce', 'woo-banner-management' );
?></a>
                </li>
                <li>
                    <img  class="sidebar_plugin_icone" src="<?php 
echo  esc_url( plugins_url( '/images/popular-plugins/WooCommerce-Blocker-Prevent-Fake-Orders.png', dirname( dirname( __FILE__ ) ) ) ) ;
?>">
                    <a target="_blank" href="<?php 
echo  esc_url( 'https://www.thedotstore.com/woocommerce-anti-fraud' ) ;
?>"><?php 
esc_html_e( 'Fraud Prevention Plugin for WooCommerce', 'woo-banner-management' );
?></a>
                </li>
                <li>
                    <img  class="sidebar_plugin_icone" src="<?php 
echo  esc_url( plugins_url( '/images/popular-plugins/hide-shipping-method-for-woocommerce.png', dirname( dirname( __FILE__ ) ) ) ) ;
?>">
                    <a target="_blank" href="<?php 
echo  esc_url( 'https://www.thedotstore.com/hide-shipping-method-for-woocommerce' ) ;
?>"><?php 
esc_html_e( 'Hide Shipping Method For WooCommerce', 'woo-banner-management' );
?></a>
                </li>
                </br>
            </ul>
