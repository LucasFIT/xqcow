...
?></td>
                <td class="fr-2"><?php 
esc_html_e( 'English, Spanish, French', 'woo-banner-management' );
?></td>
            </tr>
            <tr>
                <td class="fr-1"><?php 
...
?></td>
            ...
            <tr>
                <td class="fr-1"><?php 
esc_html_e( 'Website other page banner', 'woo-banner-management' );
?></td>
                <td class="fr-2"><?php 
esc_html_e( '[display_page_banner]', 'woo-banner-management' );
?></td>
            </tr>
            </tbody>
        </table>
