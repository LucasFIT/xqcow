...
<table class="form-table">
	...
	<tr class="radio-span" >
		<td>
		<input type="text" class="pro_text" id="countdown_date" name="countdown_date" readonly placeholder="<?php _e('Select Your Countdown Start date','SAHU_SO_TEXT_DOMAIN'); ?>" size="56" value="<?php echo esc_attr($sahu_so_countdown['countdown_date']); ?>" />
		</td>
	</tr>
